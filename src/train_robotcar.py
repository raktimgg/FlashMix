...
def main(args):
    ...
    loader = torch.utils.data.DataLoader(dset, batch_size=buffer_batch_size, collate_fn=collate_fn, shuffle=False, num_workers=16)
    ...
    if do_validation:
        ...
        val_loader = torch.utils.data.DataLoader(val_dset, batch_size=buffer_batch_size, collate_fn=collate_fn, shuffle=False, num_workers=16)
    ...
    local_feature_path = 'src/utils/local_features_robotcar_1.npy'
    gt_pose_path = 'src/utils/gt_pose_robotcar_1.npy'
    xyz_path = 'src/utils/xyz_robotcar_1.npy'
    ...
    if do_validation:
        ...
        local_feature_val_path = 'src/utils/local_features_robotcar_val.npy'
        gt_pose_val_path = 'src/utils/gt_pose_robotcar_val.npy'
        xyz_val_path = 'src/utils/xyz_robotcar_val.npy'
    ...
    np.save('src/utils/robotcar_feature_mean.npy', mean)
    np.save('src/utils/robotcar_feature_std.npy', std)
    ...
    for e in range(MAX_EPOCH):
        ...
        for i in range(int(len(batch_indices)/batch_size)):
            ...
            with autocast('cuda'):
                ...
                pairs = find_anchor_positive_negative_pairs_indices(emb, labels)  # anchor, positive, negative
        ...
        print(f'Avg. Contrastive/Metric Loss {epoch_loss_batch_avg:.5f}')

        save_loc = args['training']['save_folder'] + '/robotcar_regressor_' + str(exp_num) + '.pth'
        ...
        if do_validation:
            ...
            with torch.inference_mode():
                ...
                with autocast('cuda'):
                    ...
                    loss1, loss_t, loss_q = pose_loss(pred_t, pred_q, gt_t*std_t*1, gt_q*1)
